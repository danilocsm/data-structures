	...
	#define FALSE 0
		...
		int dllInsertAfterSpec(DLList *l,void *elm,void *key,int(*cmp)(void*,void*));
		int dllInsertBeforeSpec(DLList *l,void *elm,void *key,int(*cmp)(void*,void*));	
		...
		int dllComuns(DLList *l1,DLList *l2,DLList *l3,int(*cmp)(void*,void*));
	#else
		...
		extern int dllInsertAfterSpec(DLList *l,void *elm,void *key,int(*cmp)(void*,void*));
		extern int dllInsertBeforeSpec(DLList *l,void *elm,void *key,int(*cmp)(void*,void*));	
		...
		extern int dllComuns(DLList *l1,DLList *l2,DLList *l3,int(*cmp)(void*,void*));
	#endif
