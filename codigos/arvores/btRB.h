  ...
  #define BTRB_H_INCLUDED
   //#ifdef btRB_c
      ...
      RBnode *btInsert(RBnode *root,RBnode *pt,int(*cmp)(void*,void*),void*(*helpFunction)(void *),int *flag);
      RBnode * rbInsert(RBnode *root,void *elm,int(*cmp)(void*,void*),void*(*helpFunction)(void *),int *distinct);
      ...
      //int rbSearch(RBnode *t,void *key,int(*cmp)(void*,void*));
   ...
   /*#else
      ...
      extern RBnode *bstInsert(RBnode *root,RBnode *pt,int(*cmp)(void*,void*),void(*helpFunction)(void**));
      extern RBnode * rbInsert(RBnode *root,void *elm,int(*cmp)(void*,void*),void(*helpFunction)(void**));
      extern RBnode *rbFixRemoval(RBnode *root,RBnode *pt,RBnode *pt_parent);
      extern RBnode *rbRemove(RBnode *root,void *key,int(*cmp)(void*,void*));
      extern int rbSearch(RBnode *t,void *key,int(*cmp)(void*,void*));
      extern int rbAltura(RBnode *t);
      extern void rbSimetrica(RBnode *t,void(*visit)(void*,int));
   #endif*/
#endif
