...
/*#else
   ...
   extern AVLNode *avlInsert(AVLNode *t,void
   *elm,int(*cmp)(void*,void*),void(*helpFunction)(void**)); extern AVLNode
   *avlRemove(AVLNode *t,void *elm,int(*cmp)(void*,void*)); extern int
   avlSearch(AVLNode *t,void *key,int(*cmp)(void*,void*)); extern int
   avlHeight(AVLNode *t); extern int getBalance(AVLNode *t); extern AVLNode
   *rotateRight(AVLNode *t); extern AVLNode *rotateLeft(AVLNode *t); extern void
   Simetrica(AVLNode *t,void(*visit)(void*));*/
// #endif
#endif
